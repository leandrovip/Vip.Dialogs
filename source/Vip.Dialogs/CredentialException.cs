...
namespace Vip.Dialogs
{
    ...
    public class CredentialException : Win32Exception
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="CredentialException" /> class with the specified error and the
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="CredentialException" /> class with a specified error message and a
