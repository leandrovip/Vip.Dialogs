...
namespace Vip.Dialogs
{
    ...
    public class TimerEventArgs : EventArgs
    {
        ...
        /// </summary>
        /// <value>
        ///     <see langword="true" /> to reset the tick count after the event handler returns; otherwise,
        ///     <see langword="false" />.
        ...
        /// </summary>
        /// <value>
        ///     The number of milliseconds that has elapsed since the dialog was created or since the last time the event handler
        ///     returned
