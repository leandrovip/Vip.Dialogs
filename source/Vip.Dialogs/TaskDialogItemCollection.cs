...
namespace Vip.Dialogs
{
    ...
    public class TaskDialogItemCollection<T> : Collection<T> where T : TaskDialogItem
    {
        ...
        ///     The <see cref="TaskDialogItem" /> specified in <paramref name="item" /> is already
        ///     associated with a different task dialog.
        /// </exception>
        /// <exception cref="InvalidOperationException">
        ///     The <see cref="TaskDialogItem" /> specified in <paramref name="item" /> has
        ///     a duplicate id or button type.
        /// </exception>
