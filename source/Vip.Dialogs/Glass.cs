...
namespace Vip.Dialogs
{
    ...
    ///         respond to changes in the Desktop Window Manager state and enable/disable client area glass as necessary. It
    ///         also
    ///         allows the window to be dragged using the client area glass areas using the
    ///         <see cref="ExtendedForm.AllowGlassDragging" />
    ///         property.
    ///     </para>
    ///     <note>
    ...
    public static class Glass
    {
        ...
        /// </summary>
        /// <value>
        ///     <see langword="true" /> on operating systems that support the Desktop Window Manager (Windows Vista and higher);
        ...
        public static bool IsDwmCompositionEnabled
            => OSSupportsDwmComposition && NativeMethods.DwmIsCompositionEnabled();
        ...
        public static void ExtendFrameIntoClientArea(this IWin32Window window, Padding glassMargin)
        {
            ...
            var margins = new NativeMethods.MARGINS(glassMargin);
