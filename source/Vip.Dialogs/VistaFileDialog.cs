...
namespace Vip.Dialogs
{
    ...
    public abstract class VistaFileDialog : CommonDialog
    {
        ...
        /// </value>
        [Browsable(false)]
        public static bool IsVistaFileDialogSupported => Environment.OSVersion.Platform == PlatformID.Win32NT &&
        ...
        /// </summary>
        /// <value>
        ///     <see langword="true" /> if the dialog box adds an extension to a file name if the user omits the extension;
        ...
        /// </summary>
        /// <value>
        ///     <see langword="true" /> if the dialog box displays a warning when the user specifies a path that does not exist;
        ///     otherwise, <see langword="false" />.
        ///     The default value is <see langword="true" />.
        /// </value>
        [Description(
        ...
        /// </summary>
        /// <value>
        ///     <see langword="true" /> if the dialog box restores the current directory to its original value if the user changed
        ///     the
        ...
        /// </summary>
        /// <value>
        ///     <see langword="true" /> if the dialog box includes a help button; otherwise, <see langword="false" />. The default
        ...
        /// </summary>
        /// <value>
        ///     <see langword="true" /> if the dialog box supports multiple file name extensions; otherwise,
        ...
        /// </summary>
        /// <value>
        ///     <see langword="true" /> if the dialog box accepts only valid Win32 file names; otherwise, <see langword="false" />.
        ///     The default value is <see langword="true" />.
        /// </value>
        [DefaultValue(true)]
        [Category("Behavior")]
        ...
        {
            if (DownlevelDialog != null)
                return DownlevelDialog.ShowDialog(hwndOwner == IntPtr.Zero
                           ? null
        ...
        /// <summary>
        ///     Releases the unmanaged resources used by the <see cref="VistaFileDialog" /> and optionally releases the managed
        ///     resources.
        /// </summary>
