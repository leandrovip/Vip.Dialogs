...
namespace Vip.Dialogs
{
    ...
    ///     </para>
    ///     <para>
    ///         As of .Net 3.5 and .Net 2.0 SP1, the regular <see cref="System.Windows.Forms.OpenFileDialog" /> class will also
    ///         use
    ...
    public class VistaOpenFileDialog : VistaFileDialog
    {
        ...
        /// </summary>
        /// <value>
        ///     <see langword="true" /> if the dialog box contains a read-only check box; otherwise, <see langword="false" />. The
        ...
        /// </summary>
        /// <value>
        ///     <see langword="true" /> if the read-only check box is selected; otherwise, <see langword="false" />. The default
