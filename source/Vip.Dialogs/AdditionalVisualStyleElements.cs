    ...
    public static class AdditionalVisualStyleElements
    {
        ...
        public static class TextStyle
        {
            ...
            public static VisualStyleElement MainInstruction
                => _mainInstruction ?? (_mainInstruction = VisualStyleElement.CreateElement(_className, 1, 0));
            ...
            public static VisualStyleElement BodyText
                => _bodyText ?? (_bodyText = VisualStyleElement.CreateElement(_className, 4, 0));
        }
        ...
        public static class TaskDialog
        {
            ...
            public static VisualStyleElement PrimaryPanel
                => _primaryPanel ?? (_primaryPanel = VisualStyleElement.CreateElement(_className, 1, 0));
            ...
            public static VisualStyleElement SecondaryPanel
                => _secondaryPanel ?? (_secondaryPanel = VisualStyleElement.CreateElement(_className, 8, 0));
        }
    }
}