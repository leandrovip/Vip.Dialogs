...
namespace Vip.Dialogs
{
    ...
    public abstract partial class TaskDialogItem : Component
    {
        ...
        ///     </para>
        ///     <para>
        ///         If this property is zero when the <see cref="TaskDialogItem" /> is added to the
        ///         <see cref="TaskDialog.Buttons" />
        ...
        ///     collection of the <see cref="TaskDialog" /> instance this item is part of. For <see cref="TaskDialogRadioButton" />
        ///     items, the <see cref="TaskDialog.RadioButtons" />
        ///     collection of the <see cref="TaskDialog" /> instance this item is part of. If the <see cref="TaskDialogItem" /> is
        ///     not
