...
namespace Vip.Dialogs
{
    ...
    public partial class InputDialog : Component, IBindableComponent
    {
        ...
        /// </summary>
        /// <remarks>
        ///     The value of the <see cref="Input" /> property is updated only when the user clicks OK and the dialog is closed,
        ///     not while
        ...
        /// </summary>
        /// <remarks>
        ///     Set the <see cref="CancelEventArgs.Cancel" /> property to <see langword="true" /> to prevent the dialog from
        ///     closing.
        /// </remarks>
        [Category("Action")]
        ...
        /// </value>
        /// <remarks>
        ///     When running on Windows Vista or newer, the main instruction of the input dialog will be displayed in a larger font
        ///     and a different color than
        ...
        /// </value>
        /// <remarks>
        ///     Setting this property before calling <see cref="ShowDialog()" /> determines the initial text in the input field.
        ///     Retrieving
        ...
        [DefaultValue((int) short.MaxValue)]
        public int MaxLength { get; set; } = short.MaxValue;

        /// <summary>
        ///     Gets or sets a value that indicates whether the input will be masked using the system password character.
        /// </summary>
        /// <value>
        ///     <see langword="true" /> if the input is masked; otherwise, <see langword="false" />. The default value is
        ///     <see langword="false" />.
        /// </value>
        [Category("Behavior")]
        ...
        {
            using (var frm = new InputDialogForm())
            {
                ...
                frm.OkButtonClicked += InputBoxForm_OkButtonClicked;
