...
namespace Vip.Dialogs
{
    ...
    public partial class CredentialDialog : Component
    {
        ...
        /// </summary>
        /// <value>
        ///     <see langword="true" /> when credentials are saved in the application instance cache; <see langref="false" /> if
        ///     they are not.
        ///     The default value is <see langword="false" />.
        /// </value>
        /// <remarks>
        ///     <para>
        ///         The application instance credential cache stores credentials in memory while an application is running. When
        ///         the
        ///         application exits, this cache is not persisted.
        ///     </para>
        ///     <para>
        ///         When the <see cref="UseApplicationInstanceCredentialCache" /> property is set to <see langword="true" />,
        ///         credentials that
        ///         are confirmed with <see cref="ConfirmCredentials" /> when the user checked the "save password" option will be
        ///         stored
        ///         in the application instance cache as well as the operating system credential store.
        ///     </para>
        ///     <para>
        ///         When <see cref="ShowDialog()" /> is called, and credentials for the specified <see cref="Target" /> are already
        ///         present in
        ...
        ///     </para>
        ///     <para>
        ///         The application instance credential cache allows you to prevent prompting the user again for the lifetime of
        ///         the
        ///         application if the "save password" checkbox was checked, but when the application is restarted you can prompt
        ///         again
        ///         (initializing the dialog with the saved credentials). To get this behaviour, the
        ///         <see cref="ShowUIForSavedCredentials" />
        ...
        /// </value>
        /// <remarks>
        ///     Credentials are stored on a per user, not on a per application basis. To ensure that credentials stored by
        ///     different
        ...
        /// <remarks>
        ///     <para>
        ///         This property is not used on Windows Vista and newer versions of windows; the window title will always be
        ///         "Windows Security"
        ///         in that case.
        ///     </para>
        /// </remarks>
        ...
        ///         from the other text. In the default style, this text is a slightly larger and colored blue. The style is
        ///         identical
        ...
        /// <remarks>
        ///     <para>
        ///         On Windows Vista and newer versions of Windows, this text is placed below the <see cref="MainInstruction" />
        ///         text.
        ///     </para>
        ///     <para>
        ...
        /// <summary>
        ///     Gets or sets a value that indicates how the text of the <see cref="MainInstruction" /> and <see cref="Content" />
        ///     properties
        ...
        /// <remarks>
        ///     <para>
        ///         Windows XP does not support the distinct visual style of the main instruction, so there is no visual difference
        ///         between the
        ///         text of the <see cref="CredentialDialog.MainInstruction" /> and <see cref="CredentialDialog.Content" />
        ...
        /// <summary>
        ///     Gets or sets a value that indicates whether a check box is shown on the dialog that allows the user to choose
        ///     whether to save
        ...
        /// </value>
        /// <remarks>
        ///     When this property is set to <see langword="true" />, you must call the <see cref="ConfirmCredentials" /> method to
        ///     save the
        ///     credentials. When this property is set to <see langword="false" />, the credentials will never be saved, and you
        ///     should not call
        ...
        /// <summary>
        ///     Gets or sets a value that indicates whether the dialog should be displayed even when saved credentials exist for
        ///     the
        ///     specified target.
        /// </summary>
        /// <value>
        ...
        ///         <see cref="ShowDialog()" />.
        ///         If the dialog was shown, this property will be <see langword="false" />; if the credentials were retrieved from
        ///         the
        ///         application instance cache or the credential store and the dialog was not shown it will be
        ///         <see langword="true" />.
        ///     </para>
        ///     <para>
        ///         If the <see cref="ShowUIForSavedCredentials" /> property is set to <see langword="true" />, and the dialog is
        ///         shown
        ...
        ///         <item>
        ///             <description>
        ///                 <see cref="UseApplicationInstanceCredentialCache" /> is <see langword="true" /> and the application
        ///                 instance
        ...
        ///                 <see langword="false" />, and the operating system credential store
        ///                 for the current user contains credentials for the specified <see cref="Target" />.
        ///             </description>
        ///         </item>
        ///     </list>
        ///     <para>
        ///         In these cases, the <see cref="Credentials" />, <see cref="UserName" /> and <see cref="Password" /> properties
        ///         will
        ...
        public DialogResult ShowDialog(IWin32Window owner)
        {
            ...
            var ownerHandle = owner == null ? NativeMethods.GetActiveWindow() : owner.Handle;
            bool result;
        ...
        /// </summary>
        /// <param name="confirm">
        ///     <see langword="true" /> if the credentials that were specified on the dialog are valid;
        ///     otherwise, <see langword="false" />.
        /// </param>
        /// <remarks>
        ///     Call this function after calling <see cref="ShowDialog()" /> when <see cref="ShowSaveCheckBox" /> is
        ///     <see langword="true" />.
        ///     Only when this function is called with <paramref name="confirm" /> set to <see langword="true" /> will the
        ///     credentials be
        ...
        /// <remarks>
        ///     <para>
        ///         If the requested credential was not originally stored using the <see cref="CredentialDialog" /> class (but e.g.
        ///         by
        ///         another application), the password may not be decoded correctly.
        ///     </para>
        ///     <para>
        ///         This function does not check the application instance credential cache for the credentials; for that you can
        ///         use
        ...
        /// <remarks>
        ///     <para>
        ///         This function will only check the the application instance credential cache; the operating system's credential
        ///         store
        ///         is not checked. To retrieve credentials from the operating system's store, use
        ///         <see cref="RetrieveCredential" />.
        ///     </para>
        /// </remarks>
        /// <exception cref="ArgumentNullException"><paramref name="target" /> is <see langword="null" />.</exception>
        /// <exception cref="ArgumentException"><paramref name="target" /> is an empty string ("").</exception>
        ...
        ///     An error occurred deleting the credentials from the operating system's credential
        ///     store.
        /// </exception>
        ...
        private bool PromptForCredentialsCredUI(IntPtr owner, bool storedCredentials)
        {
            ...
            var flags = NativeMethods.CREDUI_FLAGS.GENERIC_CREDENTIALS | NativeMethods.CREDUI_FLAGS.DO_NOT_PERSIST |
            ...
            var result = NativeMethods.CredUIPromptForCredentials(ref info, Target, IntPtr.Zero, 0, user,
                NativeMethods.CREDUI_MAX_USERNAME_LENGTH, pw, NativeMethods.CREDUI_MAX_PASSWORD_LENGTH,
        ...
        private bool PromptForCredentialsCredUIWin(IntPtr owner, bool storedCredentials)
        {
            ...
            try
            {
                ...
                uint outBufferSize;
                uint package = 0;
                var result = NativeMethods.CredUIPromptForWindowsCredentials(ref info, 0, ref package, inBuffer,
                    inBufferSize, out outBuffer, out outBufferSize, ref _isSaveChecked, flags);
                switch (result)
                {
                    case NativeMethods.CredUIReturnCodes.NO_ERROR:
