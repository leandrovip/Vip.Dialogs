...
namespace Vip.Dialogs
{
    ...
    public class TaskDialogButton : TaskDialogItem
    {
        ...
        /// </summary>
        /// <value>
        ///     One of the <see cref="Dialogs.ButtonType" /> values that indicates the type of the button. The default value
        ///     is <see cref="Dialogs.ButtonType.Custom" />.
        /// </value>
        [Category("Appearance")]
        ...
        ///         is <see cref="Dialogs.ButtonType.Custom" />. For other button types, it is ignored.
        ///     </para>
        ///     <para>
        ...
        /// </summary>
        /// <value>
        ///     <see langword="true" /> if the button is the default button; otherwise, <see langword="false" />.
        ///     The default value is <see langword="false" />.
        /// </value>
        /// <remarks>
        ///     If no button has this property set to <see langword="true" />, the first button on the dialog will be the default
        ///     button.
        /// </remarks>
        [Category("Behavior")]
