...
namespace Vip.Dialogs
{
    ...
    /// </summary>
    /// <remarks>
    ///     The task dialog contains an application-defined message text and title, icons, and any combination of predefined
    ///     push buttons.
    ///     Task Dialogs are supported only on Windows Vista and above. No fallback is provided; if you wish to use task
    ///     dialogs
    ///     and support operating systems older than Windows Vista, you must provide a fallback yourself. Check the
    ///     <see cref="OSSupportsTaskDialogs" />
    ///     property to see if task dialogs are supported. It is safe to instantiate the <see cref="TaskDialog" /> class on an
    ///     older
    ...
    public partial class TaskDialog : Component, IWin32Window
    {
        ...
        /// </summary>
        /// <remarks>
        ///     Set the <see cref="CancelEventArgs.Cancel" /> property to <see langword="true" /> to prevent the dialog from being
        ///     closed.
        /// </remarks>
        [Category("Action")]
        ...
        /// <remarks>
        ///     <para>
        ///         This event is raised only when the <see cref="RaiseTimerEvent" /> property is set to <see langword="true" />.
        ///         The event is
        ...
        public TaskDialogItemCollection<TaskDialogButton> Buttons
            => _buttons ?? (_buttons = new TaskDialogItemCollection<TaskDialogButton>(this));
        ...
        public TaskDialogItemCollection<TaskDialogRadioButton> RadioButtons
            => _radioButtons ?? (_radioButtons = new TaskDialogItemCollection<TaskDialogRadioButton>(this));
        ...
        [Category("Appearance")]
        [Description(
            "The icon to be used in the title bar of the dialog. Used only when the dialog is shown as a modeless dialog.")]
        [DefaultValue(null)]
        public Icon WindowIcon
        {
            get
            {
                if (IsDialogRunning)
                {
                    var icon = NativeMethods.SendMessage(Handle, NativeMethods.WM_GETICON,
        ...
        /// </value>
        /// <remarks>
        ///     When this property is set to <see cref="TaskDialogIcon.Custom" />, use the <see cref="CustomMainIcon" /> property
        ///     to
        ...
        /// </value>
        /// <remarks>
        ///     This property is ignored if the <see cref="MainIcon" /> property has a value other than
        ...
        /// <remarks>
        ///     <para>
        ///         When this property is set to <see cref="TaskDialogIcon.Custom" />, use the <see cref="CustomFooterIcon" />
        ///         property to
        ///         specify the icon to use.
        ///     </para>
        ///     <para>
        ...
        /// <remarks>
        ///     <para>
        ///         This property is ignored if the <see cref="FooterIcon" /> property has a value other than
        ///         <see cref="TaskDialogIcon.Custom" />.
        ///     </para>
        ///     <para>
        ///         The footer icon is displayed only if the <see cref="Footer" /> property is not an empty string ("").
        ...
        ///         with <see cref="TaskDialog.ButtonStyle" /> set to
        ///         <see cref="TaskDialogButtonStyle.CommandLinks" />
        ...
        {
            get => GetFlag(NativeMethods.TaskDialogFlags.UseCommandLinksNoIcon)
            ...
            set
            {
                ...
                SetFlag(NativeMethods.TaskDialogFlags.UseCommandLinksNoIcon,
                    value == TaskDialogButtonStyle.CommandLinksNoIcon);
                UpdateDialog();
            }
        }
        ...
        /// <remarks>
        ///     <para>
        ///         If this text is not specified and <see cref="CollapsedControlText" /> is specified, the value of
        ///         <see cref="CollapsedControlText" />
        ///         will be used for this property as well. If neither is specified, the operating system's default text is used.
        ///     </para>
        ///     <note>
        ///         The control for collapsing or expanding the expandable information is displayed only if
        ///         <see cref="ExpandedInformation" /> is not
        ///         an empty string ("")
        ///     </note>
        /// </remarks>
        [Localizable(true)]
        ...
        /// <remarks>
        ///     <para>
        ///         If this text is not specified and <see cref="ExpandedControlText" /> is specified, the value of
        ///         <see cref="ExpandedControlText" />
        ///         will be used for this property as well. If neither is specified, the operating system's default text is used.
        ///     </para>
        ///     <note>
        ///         The control for collapsing or expanding the expandable information is displayed only if
        ...
        [Category("Appearance")]
        [Description(
            "the width of the task dialog's client area in DLU's. If 0, task dialog will calculate the ideal width.")]
        [DefaultValue(0)]
        public int Width
        {
        ...
        /// <summary>
        ///     Gets or sets a value that indicates whether hyperlinks are allowed for the <see cref="Content" />,
        ///     <see cref="ExpandedInformation" />
        ///     and <see cref="Footer" /> properties.
        /// </summary>
        /// <value>
        ///     <see langword="true" /> when hyperlinks are allowed for the <see cref="Content" />,
        ///     <see cref="ExpandedInformation" />
        ///     and <see cref="Footer" /> properties; otherwise, <see langword="false" />. The default value is
        ///     <see langword="false" />.
        /// </value>
        /// <remarks>
        ///     <para>
        ///         When  this property is <see langword="true" />, the <see cref="Content" />, <see cref="ExpandedInformation" />
        ///         and <see cref="Footer" /> properties can use hyperlinks in the following form:
        ///         <c>&lt;A HREF="executablestring"&gt;Hyperlink Text&lt;/A&gt;</c>
        ///     </para>
        ///     <note>
        ...
        [Category("Behavior")]
        [Description(
            "Indicates whether hyperlinks are allowed for the Content, ExpandedInformation and Footer properties.")]
        [DefaultValue(false)]
        ...
        [Category("Behavior")]
        [Description(
            "Indicates that the dialog should be able to be closed using Alt-F4, Escape and the title bar's close button even if no cancel button is specified.")]
        [DefaultValue(false)]
        ...
        [Category("Behavior")]
        [Description(
            "Indicates that the string specified by the ExpandedInformation property should be displayed by default.")]
        [DefaultValue(false)]
        ...
        /// </value>
        /// <remarks>
        ///     The <see cref="Timer" /> event will be raised approximately every 200 milliseconds if this property is
        ///     <see langword="true" />.
        /// </remarks>
        [Category("Behavior")]
        ...
        /// </summary>
        /// <value>
        ///     <see langword="true" /> when the dialog is centered relative to the parent window; <see langword="false" /> when it
        ...
        /// </summary>
        /// <value>
        ///     <see langword="true" /> when the content of the dialog is displayed right to left; otherwise,
        ///     <see langword="false" />.
        ///     The default value is <see langword="false" />.
        /// </value>
        [Localizable(true)]
        ...
        /// </summary>
        /// <value>
        ///     A <see cref="Dialogs.ProgressBarStyle" /> that indicates the type of progress bar shown on the task dialog.
        /// </value>
        /// <remarks>
        ///     <para>
        ///         If this property is set to <see cref="Dialogs.ProgressBarStyle.MarqueeProgressBar" />, the marquee will
        ///         scroll as long as the dialog is visible.
        ///     </para>
        ///     <para>
        ///         If this property is set to <see cref="Dialogs.ProgressBarStyle.ProgressBar" />, the value of the
        ...
        ///     </para>
        ///     <note>
        ///         Updating the value of the progress bar using the <see cref="ProgressBarValue" /> while the dialog is visible
        ///         property may only be done from
        ...
        public ProgressBarStyle ProgressBarStyle
        {
            ...
            set
            {
                SetFlag(NativeMethods.TaskDialogFlags.ShowMarqueeProgressBar,
                    value == ProgressBarStyle.MarqueeProgressBar);
        ...
        ///     <see cref="Dialogs.ProgressBarStyle.MarqueeProgressBar" />.
        /// </remarks>
        [Category("Behavior")]
        ...
        /// <remarks>
        ///     This property is only used if the <see cref="ProgressBarStyle" /> property is
        ///     <see cref="Dialogs.ProgressBarStyle.ProgressBar" />.
        /// </remarks>
        /// <exception cref="ArgumentOutOfRangeException">
        ///     The new property value is not smaller than
        ///     <see cref="ProgressBarMaximum" />.
        /// </exception>
        [Category("Behavior")]
        ...
        /// </remarks>
        /// <exception cref="ArgumentOutOfRangeException">
        ///     The new property value is smaller than <see cref="ProgressBarMinimum" />
        ///     or larger than <see cref="ProgressBarMaximum" />.
        /// </exception>
        [Category("Behavior")]
        ...
        /// </summary>
        /// <value>
        ///     A <see cref="Dialogs.ProgressBarState" /> indicating the state of the task dialog's progress bar.
        ///     The default value is <see cref="Dialogs.ProgressBarState.Normal" />.
        /// </value>
        /// <remarks>
        ///     This property is only used if the <see cref="Dialogs.ProgressBarStyle" /> property is
        ///     <see cref="Dialogs.ProgressBarStyle.ProgressBar" />.
        /// </remarks>
        [Category("Behavior")]
        ...
        /// </summary>
        /// <returns>
        ///     The button that the user clicked. Can be <see langword="null" /> if the user cancelled the dialog using the
        ...
        ///     <see langword="true" /> to set the state of the checkbox to be checked;
        ///     <see langword="false" /> to set it to be unchecked.
        /// </param>
        /// <param name="setFocus">
        ///     <see langword="true" /> to set the keyboard focus to the checkbox; otherwise
        ///     <see langword="false" />.
        /// </param>
        ...
        public void ClickVerification(bool checkState, bool setFocus)
        {
            ...
            NativeMethods.SendMessage(Handle, (int) NativeMethods.TaskDialogMessages.ClickVerification,
                new IntPtr(checkState ? 1 : 0), new IntPtr(setFocus ? 1 : 0));
        }
        ...
        internal void SetItemEnabled(TaskDialogItem item)
        {
            if (IsDialogRunning)
                NativeMethods.SendMessage(Handle,
                    (int) (item is TaskDialogButton
                        ? NativeMethods.TaskDialogMessages.EnableButton
                        : NativeMethods.TaskDialogMessages.EnableRadioButton), new IntPtr(item.Id),
                    new IntPtr(item.Enabled ? 1 : 0));
        }
        ...
        internal void SetButtonElevationRequired(TaskDialogButton button)
        {
            if (IsDialogRunning)
                NativeMethods.SendMessage(Handle,
                    (int) NativeMethods.TaskDialogMessages.SetButtonElevationRequiredState, new IntPtr(button.Id),
                    new IntPtr(button.ElevationRequired ? 1 : 0));
        }
        ...
        internal void ClickItem(TaskDialogItem item)
        {
            ...
            NativeMethods.SendMessage(Handle,
                (int) (item is TaskDialogButton
                    ? NativeMethods.TaskDialogMessages.ClickButton
                    : NativeMethods.TaskDialogMessages.ClickRadioButton), new IntPtr(item.Id), IntPtr.Zero);
        }
        ...
        private TaskDialogButton ShowDialog(IntPtr owner)
        {
            ...
            try
            {
                ...
                {
                    NativeMethods.TaskDialogIndirect(ref _config, out buttonId, out radioButton,
        ...
        private void SetElementText(NativeMethods.TaskDialogElements element, string text)
        {
            if (IsDialogRunning)
            {
                ...
                try
                {
                    var result = NativeMethods.SendMessage(Handle,
                        (int) NativeMethods.TaskDialogMessages.SetElementText, new IntPtr((int) element), newTextPtr);
                }
                finally
                {
        ...
        private static void MarshalButtons(List<NativeMethods.TASKDIALOG_BUTTON> buttons, out IntPtr buttonsPtr,
            out uint count)
        {
        ...
        private List<NativeMethods.TASKDIALOG_BUTTON> SetupButtons()
        {
            ...
            foreach (var button in Buttons)
            {
                ...
                if (button.ButtonType == ButtonType.Custom)
                {
                    ...
                    if (ButtonStyle == TaskDialogButtonStyle.CommandLinks ||
                        ButtonStyle == TaskDialogButtonStyle.CommandLinksNoIcon &&
                        !string.IsNullOrEmpty(button.CommandLinkNote))
            ...
            try
            {
                switch ((NativeMethods.TaskDialogNotifications) uNotification)
                {
                    ...
                    case NativeMethods.TaskDialogNotifications.RadioButtonClicked:
                        ...
                        {
                            radioButton.Checked =
                                true; // there's no way to click a radio button without checking it, is there?
        ...
        private void DialogCreated()
        {
            if (_config.hwndParent == IntPtr.Zero && _windowIcon != null)
                NativeMethods.SendMessage(Handle, NativeMethods.WM_SETICON, new IntPtr(NativeMethods.ICON_SMALL),
                    _windowIcon.Handle);
        ...
        {
            if (IsDialogRunning)
                NativeMethods.SendMessage(Handle, (int) NativeMethods.TaskDialogMessages.SetMarqueeProgressBar,
                    new IntPtr(ProgressBarStyle == ProgressBarStyle.MarqueeProgressBar ? 1 : 0), IntPtr.Zero);
        }

        private void UpdateProgressBarMarqueeSpeed()
        {
            if (IsDialogRunning)
                NativeMethods.SendMessage(Handle, (int) NativeMethods.TaskDialogMessages.SetProgressBarMarquee,
                    new IntPtr(ProgressBarMarqueeAnimationSpeed > 0 ? 1 : 0),
        ...
        {
            if (IsDialogRunning)
                NativeMethods.SendMessage(Handle, (int) NativeMethods.TaskDialogMessages.SetProgressBarRange,
                    IntPtr.Zero, new IntPtr((ProgressBarMaximum << 16) | ProgressBarMinimum));
        ...
        {
            if (IsDialogRunning)
                NativeMethods.SendMessage(Handle, (int) NativeMethods.TaskDialogMessages.SetProgressBarPos,
                    new IntPtr(ProgressBarValue), IntPtr.Zero);
        }

        private void UpdateProgressBarState()
        {
            if (IsDialogRunning)
                NativeMethods.SendMessage(Handle, (int) NativeMethods.TaskDialogMessages.SetProgressBarState,
                    new IntPtr((int) ProgressBarState + 1), IntPtr.Zero);
        }
        ...
        private void CheckCrossThreadCall()
        {
            ...
            {
                int processId;
                var windowThreadId = NativeMethods.GetWindowThreadProcessId(handle, out processId);
