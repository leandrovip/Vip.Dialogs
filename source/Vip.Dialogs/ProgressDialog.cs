...
namespace Vip.Dialogs
{
    ...
    public partial class ProgressDialog : Component
    {
        ...
        /// <remarks>
        ///     <para>
        ///         This property must be set before <see cref="ShowDialog()" /> or <see cref="Show()" /> is called. Changing
        ///         property has
        ...
        /// <summary>
        ///     Gets or sets a value that indicates whether path strings in the <see cref="Description" /> property should be
        ///     compacted if
        ///     they are too large to fit on one line.
        /// </summary>
        /// <value>
        ...
        /// </summary>
        /// <value>
        ///     <see langword="true" /> if the user has cancelled the progress dialog; otherwise, <see langword="false" />. The
        ...
        /// </summary>
        /// <value>
        ///     One of the values of <see cref="Dialogs.ProgressBarStyle" />.
        ///     The default value is <see cref="Dialogs.ProgressBarStyle.ProgressBar" />.
        /// </value>
        /// <remarks>
        ///     <note>
        ///         Operating systems older than Windows Vista do not support marquee progress bars on the progress dialog. On
        ///         those operating systems, the
        ///         progress bar will be hidden completely if this property is
        ///         <see cref="Dialogs.ProgressBarStyle.MarqueeProgressBar" />.
        ///     </note>
        ///     <para>
        ///         When this property is set to <see cref="Dialogs.ProgressBarStyle.ProgressBar" />, use the
        ///         <see cref="ReportProgress(int)" /> method to set
        ...
        ///     The animation specified in the <see cref="Animation" /> property
        ///     could not be loaded.
        /// </exception>
        public void Show()
        {
        ...
        /// </summary>
        /// <param name="argument">
        ///     A parameter for use by the background operation to be executed in the <see cref="DoWork" />
        ///     event handler.
        /// </param>
        /// <remarks>
        ///     <para>
        ...
        ///     </para>
        ///     <para>
        ///         This method has no effect is <see cref="ProgressBarStyle" /> is
        ///         <see cref="Dialogs.ProgressBarStyle.MarqueeProgressBar" />
        ///         or <see cref="Dialogs.ProgressBarStyle.None" />.
        ///     </para>
        /// </remarks>
        ...
        /// <param name="percentProgress">The percentage, from 0 to 100, of the operation that is complete.</param>
        /// <param name="text">
        ///     The new value of the progress dialog's primary text message, or <see langword="null" /> to leave the
        ///     value unchanged.
        /// </param>
        /// <param name="description">
        ///     The new value of the progress dialog's additional description message, or
        ///     <see langword="null" /> to leave the value unchanged.
        /// </param>
        ...
        public void ReportProgress(int percentProgress, string text, string description, object userState)
        {
            ...
            _backgroundWorker.ReportProgress(percentProgress,
                new ProgressChangedData {Text = text, Description = description, UserState = userState});
        }
        ...
        private void RunProgressDialog(IntPtr owner, object argument)
        {
            ...
            if (Animation != null)
                ...
                catch (Win32Exception ex)
                {
                    throw new InvalidOperationException(
                        string.Format(CultureInfo.CurrentCulture, Resources.AnimationLoadErrorFormat, ex.Message), ex);
                }
            ...
            var flags = ProgressDialogFlags.Normal;
